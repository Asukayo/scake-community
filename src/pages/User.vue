...
<template>
  ...
  <van-cell title="性别" is-link arrow-direction="down" :value=user.gender @click="doEdit('gender','性别',user.gender)"/>
  ...
  <van-cell title="入站时间" arrow-direction="down" :value=user.createTime.toISOString() />
